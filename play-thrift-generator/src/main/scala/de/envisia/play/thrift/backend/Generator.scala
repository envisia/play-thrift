...
import de.envisia.play.thrift.ast._
import de.envisia.play.thrift.frontend.{ResolvedDocument, ScroogeInternalException}
import de.envisia.play.thrift.mustache.{Dictionary, HandlebarLoader}
...
object GeneratorFactory {
  private[this] val factories: Map[String, GeneratorFactory] = {
    ...
    val factories =
      List(ScalaGeneratorFactory) ++ loadedGenerators
